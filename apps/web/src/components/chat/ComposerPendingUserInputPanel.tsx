      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2">
          {prompt.questions.length > 1 ? (
            <span className="flex h-5 items-center rounded-full bg-muted/60 px-1.5 text-xs font-medium tabular-nums text-muted-foreground/60">
        ...
        {activeQuestion.options.map((option, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group flex w-full items-center gap-2 rounded-md border px-2 py-2 text-left text-sm transition-all duration-150",
                isSelected
            ...
            >
              {shortcutKey !== null ? (
                <kbd
                  className={cn(
                    "flex size-5 shrink-0 items-center justify-center rounded-full text-xs font-medium tabular-nums transition-colors duration-150",
                    isSelected
