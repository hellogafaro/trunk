...
/**
 * Imperative DOM-based context menu for the web application.
 * TODO(trunk-web-parity): confirm this covers every useful former native menu action,
 * then remove the remaining Electron menu contracts.
