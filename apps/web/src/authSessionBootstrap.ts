...
function renderPairingRequiredScreen(): void {
  ...
  root.innerHTML = `
    <main aria-labelledby="pairing-required-title" style="min-height:100vh;box-sizing:border-box;display:grid;place-items:center;padding:32px;background:#10110f;color:#f3f0e8;font-family:ui-sans-serif,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif">
      <section style="width:min(100%,440px)">
        ...
        <h1 id="pairing-required-title" tabindex="-1" style="margin:0;color:#f3f0e8;font-size:20px;font-weight:500;line-height:1.3;letter-spacing:-.015em">Pairing required</h1>
